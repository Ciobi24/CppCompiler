...
%token  BGIN END ASSIGN OPENBRK CLOSEDBRK IF ELSE WHILE FOR CONST EVAL TOF RETURN VOID
...
assignation: ID ASSIGN expression{
           ...
           ;
func_decl : TYPE ID '(' {incrementScope(); flag_func=1;} list_param ')' OPENBRK declarations RETURN ID ';' CLOSEDBRK {
